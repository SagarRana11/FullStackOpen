...
import {BrowserRouter as Router, Routes, Route, Link ,Navigate, useNavigate, useParams,useMatch} from "react-router-dom"
...
const Anecdote = ({anecdote}) =>(
  <div>
     ...
     <h2>has {anecdote.votes} votes</h2>
     <h2> for more info <a href={anecdote.info}>{anecdote.info}</a></h2>
  </div>
)
